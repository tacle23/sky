...
google.setOnLoadCallback(function() {
    ...
    var idd = '78FD00149654E0024644';
    var template = '11';

    var IddDepartamento = $('#IddDepartamento').val();
    ...
    $('<form/>', {
        //'action':'http://www10.directtalk.com.br/chat/?idd='+idd+'&idtemplate='+template+'&origem=GloboEsporte_ROBO&origem_loja=GloboEsporte&nome_usuario='+$('#chat_alert #nome').val()+'&cpf='+$('#chat_alert #cpfCnpj').val()+'&email='+$('#chat_alert #email').val()+'&pedido='+$('#chat_alert #pedido').val()+'&assunto='+$('#chat_alert #assunto').val(),
